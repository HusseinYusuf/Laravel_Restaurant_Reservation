            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <div class="about-images">
                        <img class="about-main" src="{{asset('assets')}}/images/about-main.jpg" alt="About Main Image">
                        <img class="about-inset" src="{{asset('assets')}}/images/about-inset.jpg" alt="About Inset Image">
                    </div>
                </div>
            </div>
            <!-- end col -->
                ...
                <div class="special-box">
                    <div id="owl-demo">
                        <div class="item item-type-zoom">
                            ...
                            <div class="item-img">
                                <img src="{{asset('assets')}}/images/special-menu-1.jpg" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
                            ...
                            <div class="item-img">
                                <img src="{{asset('assets')}}/images/special-menu-2.jpg" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
                            ...
                            <div class="item-img">
                                <img src="{{asset('assets')}}/images/special-menu-3.jpg" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
                ...
                <div class="tab-menu">
                    ...
                    <div class="slider slider-single">
                        ...
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-04.jpg" alt="" class="img-responsive">
                                    <div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-05.jpg" alt="" class="img-responsive">
                                    <div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-06.jpg" alt="" class="img-responsive">
                                    <div>
                        ...
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-07.jpg" alt="" class="img-responsive">
                                    <div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-08.jpg" alt="" class="img-responsive">
                                    <div>
                                        <h3>CHICKEN TIKKA MASALA</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-09.jpg" alt="" class="img-responsive">
                                    <div>
                                        <h3>CHICKEN TIKKA MASALA</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                        ...
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets')}}/images/menu-item-thumbnail-10.jpg" alt="" class="img-responsive">
                                    <div>
                                        <h3>MEAT FEAST PIZZA</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
